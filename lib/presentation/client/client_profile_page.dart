...
class _ClientProfilePageState extends State<ClientProfilePage> {
  ...
  Future<void> _switchToServiceProvider() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Are you sure you want to switch to Service Provider mode? Your account type will be changed and you will be redirected to the service provider dashboard.',
    ...
    if (confirmed == true) {
      ...
      try {
        // 1. Update user type to SERVICE_PROVIDER
        await _authService.updateProfile({'user_type': 'SERVICE_PROVIDER'});
        ...
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Successfully switched to Service Provider mode!'),
              backgroundColor: Colors.green,
            ),
          );

          // 5. Navigate to service provider home
          NavigationHelper.goToAndClearStack(context, '/service-home');
        }
      } catch (e) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Failed to switch to Service Provider: $e'),
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                onPressed: _switchToServiceProvider,
